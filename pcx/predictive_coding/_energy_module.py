...
class EnergyModule(Module):
    ...
    def clear_params(self, filter: Callable[[Any], bool] | type) -> None:
        """Set the selected parameters to None. This is especially useful to clear the cache of the parameters
        when needed. Note that, being pcax an imperative library, the change is done in-place and no updated
        module is returned.
